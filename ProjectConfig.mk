...
CUSTOM_HAL_IMGSENSOR = ov13855_mipi_raw s5k4h8_mipi_raw s5k5e2ya_mipi_raw ov13855_mipi_raw_qtech s5k4h8_mipi_raw_qtech s5k5e2ya_mipi_raw_qtech s5k5e8yx_mipi_raw
CUSTOM_HAL_LENS = lc898214af lc898214qtechaf
CUSTOM_HAL_MAIN2_IMGSENSOR = s5k5e2ya_mipi_raw s5k5e2ya_mipi_raw_qtech s5k5e8yx_mipi_raw
CUSTOM_HAL_MAIN_BACKUP_IMGSENSOR = ov13855_mipi_raw_qtech
CUSTOM_HAL_MAIN_BACKUP_LENS = lc898214qtechaf
...
CUSTOM_HAL_SUB_BACKUP_IMGSENSOR = s5k4h8_mipi_raw_qtech
CUSTOM_HAL_SUB_BACKUP_LENS = ad5820af
CUSTOM_HAL_SUB_IMGSENSOR = s5k4h8_mipi_raw
...
CUSTOM_KERNEL_DCT = marino
#LCSH MOD by liyeqiang for flashawb
MTK_LCT_CUSTOM_CAMERA_FLASHAWB = yes
...
CUSTOM_KERNEL_IMGSENSOR = ov13855_mipi_raw s5k4h8_mipi_raw s5k5e2ya_mipi_raw ov13855_mipi_raw_qtech s5k4h8_mipi_raw_qtech s5k5e2ya_mipi_raw_qtech s5k5e8yx_mipi_raw
CUSTOM_KERNEL_IN_POCKET_SENSOR = no
CUSTOM_KERNEL_KPD = kpd
CUSTOM_KERNEL_LEDS = mt65xx
CUSTOM_KERNEL_LENS = lc898214af lc898214qtechaf
CUSTOM_KERNEL_MAGNETOMETER = yes
CUSTOM_KERNEL_MAIN2_BACKUP_IMGSENSOR = s5k5e2ya_mipi_raw_qtech s5k5e8yx_mipi_raw
CUSTOM_KERNEL_MAIN2_IMGSENSOR = s5k5e2ya_mipi_raw
CUSTOM_KERNEL_MAIN_BACKUP_IMGSENSOR = ov13855_mipi_raw_qtech
CUSTOM_KERNEL_MAIN_BACKUP_LENS = lc898214qtechaf
...
CUSTOM_KERNEL_SUB_BACKUP_IMGSENSOR = s5k4h8_mipi_raw_qtech
CUSTOM_KERNEL_SUB_BACKUP_LENS = ad5820af
CUSTOM_KERNEL_SUB_IMGSENSOR = s5k4h8_mipi_raw
...
MTK_BUILD_VERNO = alps-mp-n1.mp5-V1.19_lenovo6757.66.n.n1_P105
MTK_BWC_SUPPORT = yes
#LCSH MOD by dingyin for 4M
MTK_C2K_LTE_MODE = 0
...
# LCSH MOD by duanlongfei for dual mic
MTK_DUAL_MIC_SUPPORT = yes
MTK_DVFS_DISABLE_LOW_VOLTAGE_SUPPORT = no
MTK_DX_HDCP_SUPPORT = no
# BEGIN Lenovo lubm1 2017-04-14 INDRIYA-396
# DUT shows enhanced4g mode with non-volte sim.
MTK_DYNAMIC_IMS_SWITCH_SUPPORT = yes
# END INDRIYA-396
MTK_DYNAMIC_SBP_SUPPORT = yes
MTK_EAP_SIM_AKA = yes
MTK_ECCCI_C2K = yes
#Lenovo-sw quebs2 modified 20160321 begin, enable secure boot
ifeq ($(SECURE_BOOT),yes)
MTK_EFUSE_WRITER_SUPPORT = yes
else
MTK_EFUSE_WRITER_SUPPORT = no
endif
#Lenovo-sw quebs2 modified 20160321 end, enable secure boot
...
#LCSH MOD by dingyin for 4M
MTK_IRAT_SUPPORT = no
#LCSH MOD by liuzhenhe for key IO
...
#LCSH MOD by dingyin for open persist partition
...
# lenono-sw zhangmiao16 20170424 INDRIYA-574 Enable USSI support
...
#lenovo-sw huangsh4 add manual shutter Begin
LENOVO_CAMERA_MANUAL_SHUTTER = yes
#lenovo-sw huangsh4 add manual shutter end
#lenovo.sw huangsh4 add for flawless
...
#ADD: longcheer_tqq_2017_02_17_for_project_name
LCT_L3510_FEATURE =yes
#add by gaochunbo for capsensor
LCT_CAPSENSOR_SUPPORT_FEATURE =yes
#add by gouxinyue for dolby
LCT_DOLBY_SUPPORT = yes
ifeq ($(LCT_DOLBY_SUPPORT),yes)
MTK_AUDENH_SUPPORT = no
MTK_BESLOUDNESS_SUPPORT = no
endif
#LCSH ADD by dingyin for fastboot flash gpt
PLATFORM_FASTBOOT_EMPTY_STORAGE = yes
#add by linjie for dialog auto close
LCT_L3510_DIALOG_AUTO_CLOSE = no
